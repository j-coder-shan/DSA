...
//        queueLinked.deQueue();
        ...
        list_array listArray = new list_array(5);
        listArray.insertLast(10);
        listArray.insertLast(20);
        listArray.insertLast(30);
        listArray.insertLast(40);
        listArray.insertLast(50);
        listArray.insertLast(60);
        listArray.traverseList();

        listArray.deleteList(1);
        listArray.traverseList();

        listArray.insertList(2, 100);
        listArray.traverseList();

        listArray.retrieveList(3);

        listArray.replaceList(0, 5);
        listArray.traverseList();
